...
add_action('wp_head', function () {
    ...
    echo '<style id="aa-post-card-placeholder">
...
add_action('wp_footer', function () {
    ...
    echo '<script id="aa-post-card-placeholder-js">'
        . '(function(map){function run(){Object.keys(map).forEach(function(id){'
        . 'var article=document.getElementById("post-"+id);if(!article)return;'
        . 'var thumb=article.querySelector(".ast-blog-featured-section.post-thumb");'
        . 'if(!thumb||thumb.querySelector("img"))return;'
        . 'var titleLink=article.querySelector(".entry-title a");'
        . 'var href=titleLink?titleLink.href:"#";'
        . 'thumb.className="ast-blog-featured-section post-thumb post-card-placeholder ast-blog-single-element";'
        . 'thumb.innerHTML='<a href="'+href+'" class="post-card-placeholder-link" tabindex="-1" aria-hidden="true">'
        . '<span>'+map[id].replace(/</g,"&lt;")+'</span></a>';});}'
